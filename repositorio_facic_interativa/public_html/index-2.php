    ...
    <body>
        ...
        <table align="center" id="menuprincipal">
            ...
            <tr>
                ...
                <td><a href="aplicarProva.php"><img src="imagens/kblackbox.png"><br>Cadastro de Perguntas</a></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="4"><a href="bibliotecas.php"><img src="imagens/kaddressbook.png"><br>Bibliotecas</a></td>
            </tr>
        </table>
        ...
        <div class="grid-90 prefix-5 principal">
            ...
            <div class="grid-10">
                <a href="exibirNotas.php"><i class="icon fa-lg rounded color6 fa-star-half-full"></i><br>Minhas Notas</a>
            </div>
            <div class="grid-10">
...
AND disciplina.idProfessor = professor.idProfessor AND semestre = '$semestre'";
            ...
            if ($linhas > 0) {
                for ($i = 0; $i < $linhas; $i++) {
                    ...
                    echo "<a href='exibirAula.php?idDisciplina=$indice' style='text-decoration:none;'><div class='lista' style='background-color:$cores[$i];'><p>$disciplina - <span>Docente: $nome</span></p></div></a>";
                    $indice++;
                    if($i==0){
...
AND disciplina.idProfessor = professor.idProfessor AND semestre = '$semestre'";
            ...
            if ($linhas > 0) {
                for ($i = 0; $i < $linhas; $i++) {
                    ...
                    $_SESSION["idDisciplina"][$indice] = $idDisciplina;
                    echo "<a href='exibirAula.php?idDisciplina=$indice' id='$idListaDisciplina' style='text-decoration:none;'><div class='lista' style='background-color:$cores[$i];'><p>$disciplina - <span>Docente: $nome</span></p></div></a>";
