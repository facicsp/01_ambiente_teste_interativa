...
<body>
    ...
    <div class="container">
    	<div class="row">
            <h1 class="titulo">Lista de Trabalhos</h1>
                    ...
                    if ($formulario) {
                        ...
                        foreach ($formulario as $form) {
                            echo "<tr>
                                ...
                                <td>{$form['titulo']}</td>
                                <td>{$form['autor']}</td>
                                <td>{$form['data_apresentacao']}</td>
                                <td><a target='_blank' href='repositorio/{$form['arquivo']}'>Baixar</td>
                                <td class='text-center'>
                                    <a href='editarepositorio.php?id={$form['id']}' class='btn btn-warning btn-action'>
                                        <i class='material-icons'>edit</i>
                                    </a>
                                </td>
                                <td class='text-center'>
                                    <a href='excluir.php?table=formulario&redirect=listarepositorio&id={$form['id']}' class='btn btn-danger btn-action'>
