...
<head>
  <title>Cadastro de Prova - VERSÃO DEBUG COM LOGS</title>
  <meta charset="UTF-8">
...
<body>
  <div class="debug-banner">
    🔍 VERSÃO DEBUG COM LOGS DETALHADOS - ABRA O CONSOLE DO NAVEGADOR (F12)
  </div>
  ...
  <script>
    console.log('%c🔍 MODO DEBUG ATIVADO', 'background: #ff6b6b; color: white; font-size: 20px; padding: 10px;');
    console.log('Esta versão salva logs detalhados em arquivos .txt no servidor');
    console.log('Todos os logs também são exibidos aqui no console do navegador');
    console.log('========================================');
  </script>
</body>
