...
// $result = mysqli_query($conexao, "SELECT idlistaresposta, resposta FROM lista_resposta
...
//   mysqli_query($conexao, "UPDATE lista_resposta SET resposta='$resposta' WHERE idlistaresposta=$id LIMIT 1");
// }